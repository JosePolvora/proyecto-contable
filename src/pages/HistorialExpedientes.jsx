...
//   // 🔹 Función para copiar número de expediente
//   // const copiarNumero = (numero) => {
//   //   navigator.clipboard
//   //     .writeText(numero)
//   //     .then(() => {
//   //       alert(`Expediente ${numero} copiado al portapapeles ✅`);
//   //     })
...
//                   {exp.usuario?.nombre} {exp.usuario?.apellido}{" "}
//                   <FaEdit
//                     style={{ cursor: "pointer", marginLeft: "8px", color: "#4caf50" }}
//                     title="Editar usuario"
//                     onClick={() =>
//                       navigate(`/admin/editar-usuario/${exp.expediente_id}`, {
